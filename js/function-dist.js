...
function fontResize() {
    var i = $(window).width();
    if (1200 <= i) var e = i / 19.05; else if (i < 1200) e = 60;
    $("body").css("fontSize", e + "%");
}

function animateBox() {
    var i = $("[data-animate]");
    i.addClass("hidden"), i.each(function(i, e) {
        var t = $(this).attr("data-animate"), o = 100;
        switch ($(this).is(".gallery__item:nth-child(even)") && (o = 200), t) {
          case "left":
            var s = "fadeInLeft";
            break;
...
function formSubmit() {
    $("[type=submit]").on("click", function(i) {
        i.preventDefault();
        var e = $(this).closest(".form"), t = e.attr("action"), o = e.serialize(), s = e.find("[required]");
        if (empty = 0, s.each(function() {
            "" == $(this).val() ? ($(this).addClass("invalid"), $(this).parent().append('<div class="form__message">Заполните обязательное поле</div>'), 
            empty++) : ($(this).removeClass("invalid"), $(this).addClass("valid"));
        }), 0 < empty) return !1;
        $.ajax({
            url: t,
            type: "POST",
            ...
            data: o,
            success: function(i) {
                $(this).attr("disabled", !0), console.log(i), $(".form__rezult").html(i);
            },
            error: function(i) {
                console.log(i);
            }
        ...
        "" != $(this).val() && ($(this).removeClass("invalid"), $(this).parent().find(".form__message").remove());
    }), $(".form__privacy input").on("change", function(i) {
        i.preventDefault();
        var e = $(this).closest(".form").find(".btn");
        $(this).prop("checked") ? e.removeAttr("disabled") : e.attr("disabled", !0);
    });
}
...
var BrowserDetect = {
    ...
    searchString: function(i) {
        for (var e = 0; e < i.length; e++) {
            var t = i[e].string, o = i[e].prop;
            if (this.versionSearchString = i[e].versionSearch || i[e].identity, t) {
                if (-1 != t.indexOf(i[e].subString)) return i[e].identity;
            } else if (o) return i[e].identity;
        }
    },
    searchVersion: function(i) {
        var e = i.indexOf(this.versionSearchString);
        if (-1 != e) return parseFloat(i.substring(e + this.versionSearchString.length + 1));
    },
    dataBrowser: [ {
...
function(p) {
    p.fn.viewportChecker = function(i) {
        var d = {
            classToAdd: "visible",
            ...
            callbackFunction: function(i, e) {},
            scrollHorizontal: !1,
            scrollBox: window
        };
        p.extend(d, i);
        var e = this, c = {
            height: p(d.scrollBox).height(),
            width: p(d.scrollBox).width()
        };
        return this.checkElements = function() {
            var l, a;
            d.scrollHorizontal ? (l = Math.max(p("html").scrollLeft(), p("body").scrollLeft(), p(window).scrollLeft()), 
            a = l + c.width) : (l = Math.max(p("html").scrollTop(), p("body").scrollTop(), p(window).scrollTop()), 
            a = l + c.height), e.each(function() {
                var i = p(this), e = {}, t = {};
                if (i.data("vp-add-class") && (t.classToAdd = i.data("vp-add-class")), i.data("vp-remove-class") && (t.classToRemove = i.data("vp-remove-class")), 
                i.data("vp-add-class-full-view") && (t.classToAddForFullView = i.data("vp-add-class-full-view")), 
                i.data("vp-keep-add-class") && (t.removeClassAfterAnimation = i.data("vp-remove-after-animation")), 
                i.data("vp-offset") && (t.offset = i.data("vp-offset")), i.data("vp-repeat") && (t.repeat = i.data("vp-repeat")), 
                i.data("vp-scrollHorizontal") && (t.scrollHorizontal = i.data("vp-scrollHorizontal")), 
                i.data("vp-invertBottomOffset") && (t.scrollHorizontal = i.data("vp-invertBottomOffset")), 
                p.extend(e, d), p.extend(e, t), !i.data("vp-animated") || e.repeat) {
                    0 < String(e.offset).indexOf("%") && (e.offset = parseInt(e.offset) / 100 * c.height);
                    var o = e.scrollHorizontal ? i.offset().left : i.offset().top, s = e.scrollHorizontal ? o + i.width() : o + i.height(), n = Math.round(o) + e.offset, r = e.scrollHorizontal ? n + i.width() : n + i.height();
                    e.invertBottomOffset && (r -= 2 * e.offset), n < a && l < r ? (i.removeClass(e.classToRemove), 
                    i.addClass(e.classToAdd), e.callbackFunction(i, "add"), s <= a && l <= o ? i.addClass(e.classToAddForFullView) : i.removeClass(e.classToAddForFullView), 
                    i.data("vp-animated", !0), e.removeClassAfterAnimation && i.one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                        i.removeClass(e.classToAdd);
                    })) : i.hasClass(e.classToAdd) && e.repeat && (i.removeClass(e.classToAdd + " " + e.classToAddForFullView), 
                    e.callbackFunction(i, "remove"), i.data("vp-animated", !1));
                }
            });
        }, ("ontouchstart" in window || "onmsgesturechange" in window) && p(document).bind("touchmove MSPointerMove pointermove", this.checkElements), 
        p(d.scrollBox).bind("load scroll", this.checkElements), p(window).resize(function(i) {
            c = {
                height: p(d.scrollBox).height(),
                width: p(d.scrollBox).width()
            }, e.checkElements();
    ...
    (s = 0, r = function(i, e) {
        ...
        !0 === i.options.dots && !0 === i.options.pauseOnDotsHover && d("li", i.$dots).on("mouseenter.slick", d.proxy(i.interrupt, i, !0)).on("mouseleave.slick", d.proxy(i.interrupt, i, !1));
        ...
        d(window).on("load.slick.slick-" + i.instanceUid, i.setPosition), d(i.setPosition);
        ...
        function i(i) {
            d("img[data-lazy]", i).each(function() {
                var i = d(this), e = d(this).attr("data-lazy"), t = d(this).attr("data-srcset"), o = d(this).attr("data-sizes") || n.$slider.attr("data-sizes"), s = document.createElement("img");
                s.onload = function() {
                    i.animate({
                        opacity: 0
                    }, 100, function() {
        ...
        o <= n.slideCount && o++)), e = n.$slider.find(".slick-slide").slice(t, o), "anticipated" === n.options.lazyLoad) for (var s = t - 1, r = o, l = n.$slider.find(".slick-slide"), a = 0; a < n.options.slidesToScroll; a++) s < 0 && (s = n.slideCount - 1), 
        ...
        i = i || 1;
        var e, t, o, s, n, r = this, l = d("img[data-lazy]", r.$slider);
        ...
        var e = d(i.target).is(".slick-slide") ? d(i.target) : d(i.target).parents(".slick-slide"), t = parseInt(e.attr("data-slick-index"));
        ...
        if (e = e || !1, !(!0 === d.animating && !0 === d.options.waitForAnimate || !0 === d.options.fade && d.currentSlide === i)) if (!1 === e && d.asNavFor(i), 
...
$(document).ready(function() {
    ...
    }), i(), $(window).resize(i), $('[href*="#"]').click(function(i) {
        i.preventDefault();
    ...
    var e = $(".header__nav").offset().top;
    $(window).scroll(function() {
        $(window).scrollTop() > e ? ($(".header__nav").appendTo(".wrapper").addClass("stiky"), 
        $(".nav__stuff").length || ($(".header__wrapper").append('<div class="nav__stuff"></div>'), 
        $(".nav__stuff").height($(".header__nav").height()))) : ($(".nav__stuff").remove(), 
        $(".header__nav").removeClass("stiky").insertAfter(".header__soc"));
    }), formSubmit(), $(".review__slider").slick({
        fade: !0
    }), checkOnResize(), animateBox();
}), $(window).resize(function(i) {
    var e = $(window).width();
    TempApp.resized != e && (TempApp.resized = e, checkOnResize());
}), $(function() {
    $(".js_youtube") && ($(".js_youtube").each(function() {
        $(this).css("background-image", "url(http://i.ytimg.com/vi/" + this.id + "/sddefault.jpg)"), 
        $(this).append($('<img src="img/play.svg" alt="Play" class="video__play">'));
    }), $(".video__play, .video__prev").on("click", function() {
        var i = "https://www.youtube.com/embed/" + $(this).closest(".js_youtube").attr("id") + "?autoplay=1&autohide=1";
        $(this).data("params") && (i += "&" + $(this).data("params"));
        var e = $("<iframe/>", {
            frameborder: "0",
            src: i,
            width: $(this).width(),
        ...
        $(this).closest(".video__wrapper").append(e);
    }));
});